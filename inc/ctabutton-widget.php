...
class ctabutton_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Call to Action Button', 'zen-life' ), // Name
      array( 'description' => __( 'Use me for the Homepage Button', 'zen-life' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( '', 'zen-life' );
