...
class homefeature_Widget extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      __( 'Homepage Feature', 'zen-life-free' ), // Name
      array( 'description' => __( 'Featured content with a button and space for an image on the homepage', 'zen-life-free' ), ) // Args
    );
  }
  ...
  public function form( $instance ) {
    $title = ! empty( $instance['title'] ) ? $instance['title'] : __( 'Feature Title', 'zen-life-free' );
    ...
    $imgurl = ! empty( $instance['imgurl'] ) ? $instance['imgurl'] : __( 'Image URL from Media Library', 'zen-life-free' );
    ?>
    ...
    <p>
    <label for="<?php echo $this->get_field_id('img_field'); ?>"><?php _e('Paste the URL of an image', 'zen-life-free'); ?></label>
